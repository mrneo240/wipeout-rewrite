...
void scene_update_aurora_borealis(void) {
	...
	for (int i = 0; i < 80; i++) {
		...
		if (aurora_borealis.grey_coords[i] != -2) {
			aurora_borealis.primitives[i]->color[0].r = (platform_sin(coords[0] * phase) * 64.0) + 190;
			aurora_borealis.primitives[i]->color[0].g = (platform_sin(coords[0] * (phase + 0.054)) * 64.0) + 190;
			aurora_borealis.primitives[i]->color[0].b = (platform_sin(coords[0] * (phase + 0.039)) * 64.0) + 190;
		}
		if (aurora_borealis.grey_coords[i] != -2) {
			aurora_borealis.primitives[i]->color[1].r = (platform_sin(coords[1] * phase) * 64.0) + 190;
			aurora_borealis.primitives[i]->color[1].g = (platform_sin(coords[1] * (phase + 0.054)) * 64.0) + 190;
		...
		if (aurora_borealis.grey_coords[i] != -1) {
			aurora_borealis.primitives[i]->color[3].r = (platform_sin(coords[3] * phase) * 64.0) + 190;
			aurora_borealis.primitives[i]->color[3].g = (platform_sin(coords[3] * (phase + 0.054)) * 64.0) + 190;
			aurora_borealis.primitives[i]->color[3].b = (platform_sin(coords[3] * (phase + 0.039)) * 64.0) + 190;
		}
	}
}
